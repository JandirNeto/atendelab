...
CREATE TABLE `atendimentos` (
  ...
  `tipos_atendimentos` int(11) NOT NULL,
  `usuario_id` int(11) NOT NULL,
  `data_atendimento` date NOT NULL,
  `hora_atendimento` time NOT NULL,
  `descricao` text NOT NULL,
  `observacao` text NOT NULL,
  `status` enum('resolvido','em espera','pendente','aberto') DEFAULT 'aberto',
...
ALTER TABLE `atendimentos`
  ...
  ADD KEY `FK_TIPO_ATENDIMENTO` (`tipos_atendimentos`),
...
ALTER TABLE `atendimentos`
  ...
  ADD CONSTRAINT `FK_TIPO_ATENDIMENTO` FOREIGN KEY (`tipos_atendimentos`) REFERENCES `tipos_atendimentos` (`id`),
