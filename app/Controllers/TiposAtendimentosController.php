...
// Gerencia operações CRUD para a tabela tipos_atendimentos.
class TiposAtendimentosController
{
    ...
    public function criar(): void
    {
        ...
        try {
            ...
            echo json_encode(['erro' => 'Erro ao cadastrar tipo de atendimento: ' . $e->getMessage()]);
        }
    }
    ...
    public function atualizar(): void
    {
        ...
        try {
            ...
            http_response_code(500);
            echo json_encode(['erro' => 'Erro ao atualizar tipo de atendimento: ' . $e->getMessage()]);
        }
    }
    ...
    public function inativar(): void
    {
        ...
        // Inativar preserva o histórico de atendimentos que usam este tipo.
        $id = filter_input(INPUT_POST, 'id', FILTER_VALIDATE_INT);
        ...
        try {
            ...
            http_response_code(500);
            echo json_encode(['erro' => 'Erro ao inativar tipo de atendimento: ' . $e->getMessage()]);
        }
    }
}
